...
public class Record implements Serializable {
	...
	public Map<String, Object> getColumns() {
		if (columns == null) {
			if (DbKit.config == null)
				columns = DbKit.brokenConfig.getColumnsMap();
			else
				columns = DbKit.config.getColumnsMap();
		}
		return columns;
	}
	...
	public String toJson() {
		return com.liucf.dbrecord.kit.JsonKit.toJson(getColumns(), 4);
	}
}
